...
function renderSchematicContent(type: string, term: TermItem, isCompact: boolean) {
  switch (type) {
    ...
    case 'ghost_text':
      return (
        <div className="w-48 bg-slate-900 border border-indigo-500 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <span className="text-slate-400 text-[8px]">Inline Ghost Autocomplete</span>
          <div className="bg-slate-950 border border-slate-700 px-2 py-1 rounded flex items-center justify-between">
            <div>
              <span className="text-white font-bold">Mit</span>
              <span className="text-slate-500">subishi_Electric|</span>
            </div>
            <span className="bg-indigo-600 text-white text-[7px] px-1 rounded font-bold">Tab ⇥</span>
          </div>
        </div>
      );
      ...
      return (
        <div className="w-48 bg-slate-900 border border-indigo-500 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <div className="relative pt-2">
            <span className="absolute top-0 left-2 bg-slate-900 px-1 text-[8px] text-indigo-400 font-bold">Part Serial No.</span>
            <div className="bg-slate-950 border-2 border-indigo-500 rounded px-2 py-1 text-slate-200">HG-SR352B|</div>
          </div>
        </div>
      );
    ...
    case 'example_chips':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1.5">
          <div className="bg-slate-950 border border-slate-700 rounded px-2 py-0.5 text-slate-400 text-[8px]">Search query...</div>
          <div className="flex gap-1 overflow-hidden">
            <span className="bg-indigo-600/30 text-indigo-300 border border-indigo-500/50 px-1.5 py-0.5 rounded text-[7px] whitespace-nowrap">⚡ 220V 3-Phase</span>
            <span className="bg-slate-800 text-slate-300 px-1.5 py-0.5 rounded text-[7px] whitespace-nowrap">350ms</span>
          </div>
        </div>
      );
    ...
    case 'microcopy':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col items-center gap-1">
          <button className="w-full bg-indigo-600 text-white py-1 rounded font-bold text-[9px] shadow">Deploy Changes</button>
          <span className="text-[7px] text-slate-400">🔒 Encrypted and safely cached locally</span>
        </div>
      );

    case 'pwd_strength':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <div className="flex justify-between text-[8px]">
            <span className="text-slate-400">Complexity</span>
            <span className="text-emerald-400 font-bold">Strong (4/4)</span>
          </div>
    ...
    case 'help_text':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <div className="bg-slate-950 border border-slate-700 px-2 py-0.5 rounded text-slate-300">usr_root_node</div>
          <span className="text-[7px] text-slate-400">ℹ Must be alphanumeric, 4-16 characters.</span>
        </div>
      );

    case 'inline_error':
      return (
        <div className="w-48 bg-rose-950/60 border border-rose-500 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <div className="bg-slate-950 border border-rose-500 px-2 py-0.5 rounded text-rose-300">admin@plc-local</div>
          <span className="text-[7px] text-rose-400 font-bold flex items-center gap-1">⚠ Invalid domain format</span>
        </div>
      );
    ...
    case 'char_counter':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <div className="bg-slate-950 border border-slate-700 px-2 py-1 rounded text-slate-300 h-8 text-[8px]">PLC Servo Alarm Log...</div>
          <div className="text-right text-[8px] font-bold text-indigo-400">42 / 100 max</div>
        </div>
      );

    case 'format_mask':
      return (
        <div className="w-48 bg-slate-900 border border-indigo-500/80 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <span className="text-slate-400 text-[8px]">Auto Format Mask</span>
          <div className="bg-slate-950 border border-slate-700 px-2 py-1 rounded text-indigo-300 font-bold tracking-wider">
            2026<span className="text-slate-600">-</span>08<span className="text-slate-600">-</span>17
          </div>
        </div>
      );
    ...
    case 'prefix_suffix':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex flex-col gap-1">
          <span className="text-slate-400 text-[8px]">Prefix & Suffix Units</span>
          <div className="flex border border-slate-700 rounded bg-slate-950 overflow-hidden">
            <span className="bg-slate-800 px-1.5 py-0.5 text-indigo-400 text-[8px] font-bold">⚡</span>
            <span className="px-2 py-0.5 text-white flex-1 font-bold">3,500</span>
            <span className="bg-slate-800 px-1.5 py-0.5 text-slate-400 text-[8px]">RPM</span>
          </div>
        </div>
      );
    ...
    case 'autosave_hint':
      return (
        <div className="w-48 bg-slate-900 border border-emerald-500/70 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex items-center justify-between">
          <div className="flex items-center gap-1.5">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
            <span className="text-emerald-300 font-bold">All Saved</span>
          </div>
    ...
    case 'conn_status':
      return (
        <div className="w-48 bg-slate-900 border border-slate-700 rounded-lg p-2 z-10 font-mono text-[9px] shadow-md flex items-center justify-between">
          <div className="flex items-center gap-1">
            <span className="w-2 h-2 rounded-full bg-emerald-500" />
            <span className="text-white font-bold text-[8px]">WebSocket</span>
          </div>
          <span className="bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 text-[7px] px-1.5 py-0.5 rounded font-bold">24ms (Live)</span>
        </div>
      );
