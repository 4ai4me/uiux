...
> **총 658개 UI/UX 컴포넌트 & 인터랙션 디자인 용어 사전 및 AI 프롬프트 엔지니어링 인터랙티브 백과사전**  
...
현대 웹/앱 디자인과 엔지니어링에 필요한 **24개 카테고리, 총 658개 전문 UI/UX 용어**를 체계적으로 분류하고, 각 용어마다 **고유한 인터랙티브 실습 랩(Live UX)**, **구조적 다이어그램(CAD Diagnostic Schematic)**, 그리고 **AI 프롬프트 생성기(Prompt Template)**를 제공합니다.

- 🎯 **정확한 AI 프롬프트 생성**: 추상적인 설명 대신 정확한 디자인 토큰과 산업 표준 기술 용어로 AI에게 프롬프트를 전달
- 🧪 **1:1 실시간 인터랙티브 랩**: 658개 모든 용어에 대해 실제 동작하는 React + Tailwind CSS 라이브 샌드박스 제공
...
| 24 | 미디어 뷰어, 물리 엔진, 오디오 및 오버레이 | Physics, Chimes, Audio & Overlay | Beaded Curtain, Chime Synth, Verlet Dynamics, Pattern Matrix, Tuner Drawer 등 |

### 2. 658개 전 항목 라이브 인터랙티브 랩 (Live UX)
